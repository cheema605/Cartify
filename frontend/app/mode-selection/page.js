...
export default function ModeSelectionPage() {
  ...
  const handleSelect = (mode) => {
    ...
    // Store mode in localStorage or context if needed
    localStorage.setItem("userMode", mode);
    // Redirect to explore page after selection
    router.push("/explore");
  };

  return (
    <div className="fixed inset-0 flex items-center justify-center bg-[#157a94] bg-opacity-90 z-50 font-serif">
